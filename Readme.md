...
describe('OAuth1.0',function(){
  ...
  it('tests trends Twitter API v1.1',function(done){
    var oauth = new OAuth.OAuth(
      ...
      'consumer_key',    // API key from section "Consumer Keys" in the Twitter Developer Portal
    ...
    oauth.get(
      ...
      'access_token', // Access token from section "Authentication Tokens" in the Twitter Developer Portal
      'token_secret', // secret
      function (e, data, res){
