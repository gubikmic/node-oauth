...
describe('OAuth1.0',function(){
  ...
  it('tests trends Twitter API v1.1',function(done){
    var oauth = new OAuth.OAuth(
      ...
      'replace with consumer_key',    // API key from section "Consumer Keys" in the Twitter Developer Portal
      'replace with consumer_secret', // secret
      null,
      'HMAC-SHA1'
    );
    oauth.get(
      'https://api.twitter.com/1.1/trends/place.json?id=23424977',
      'replace with access_token', // Access token from section "Authentication Tokens" in the Twitter Developer Portal
      'replace with token_secret', // secret
      function (e, data, res){
